...
export default function NavBar() {
  ...
  // Always show NavBar
  return (
    <nav style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 36px', marginTop: 6, marginBottom: 8, background: '#fff', minHeight: 72 }}>
      ...
      <div style={{ display: 'flex', gap: 40, alignItems: 'center' }}>
        ...
        <Link href="/specials" prefetch={true} style={{ 
          fontWeight: 700, 
          fontSize: 20, 
        ...
        <Link href="/about" prefetch={true} style={{ 
          fontWeight: 700, 
          fontSize: 20, 
        ...
        <Link href="/contact" prefetch={true} style={{ 
          fontWeight: 700, 
          fontSize: 20, 
