...
export default function About() {
  return (
    <div className="mobile-about-container" style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #fff6f6 0%, #f3e7ff 100%)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0 1rem 3rem 1rem' }}>
      <div className="mobile-about-card" style={{
        background: '#fff',
        borderRadius: 32,
        ...
        <div className="mobile-about-title" style={{ color: '#d100b6', fontWeight: 800, fontSize: 40, marginBottom: 16, letterSpacing: 1 }}>
          About Us
        </div>
        <div style={{ width: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', marginBottom: 24 }}>
          ...
          <div className="mobile-about-animation" style={{ position: 'relative', width: 105, height: 105, display: 'flex', alignItems: 'center', borderRadius: 90 , boxShadow: '0 0 20px 10px rgba(243, 4, 227, 0.6)', justifyContent: 'center' }}>
            {/* Glowing arc/halo */}
            <div style={{
              position: 'absolute',
              top: '50%',
          ...
          <div className="mobile-about-tagline" style={{ marginTop: 18, fontWeight: 600, color: '#d100b6', fontSize: 20, letterSpacing: 1, textShadow: '0 2px 8px #fff6' }}>
            Fresh, Fun & 100% Veggie Pizza!
          </div>
        </div>
        <div className="mobile-about-subtitle" style={{ color: '#b0008b', fontWeight: 700, fontSize: 32, marginBottom: 16 }}>
          Welcome to Rakesh&apos;s Pizza Shop
        </div>
        <div className="mobile-about-content" style={{ maxWidth: 700, margin: '0 auto', fontSize: 20, color: '#222', textAlign: 'left' }}>
          <div style={{ marginBottom: 24 }}>
            <div className="mobile-about-section-title" style={{ fontWeight: 600, fontSize: 26, color: '#d100b6' }}>Our Story</div>
            <div>
          ...
          <div style={{ marginBottom: 24 }}>
            <div className="mobile-about-section-title" style={{ fontWeight: 600, fontSize: 26, color: '#d100b6' }}>Our Ingredients</div>
            <div>
          ...
          <div style={{ marginBottom: 24 }}>
            <div className="mobile-about-section-title" style={{ fontWeight: 600, fontSize: 26, color: '#d100b6' }}>Our Values</div>
            <div>
          ...
          <div style={{ marginBottom: 24 }}>
            <div className="mobile-about-section-title" style={{ fontWeight: 600, fontSize: 26, color: '#d100b6' }}>Join Us on This Journey</div>
            <div>
